...
const uploadPrivateContent = async (file, status, estimatedDuration = null, onProgress = null) => {
        ...
        const pollInterval = setInterval(async () => {
          ...
          if (elapsedProcessingTime > PROCESSING_TIMEOUT_MS) {
            ...
            resolve({
              ...
              message: "Processing is taking longer than expected. Will continue in background."
            });
            return;
          }
          ...
          try {
            ...
            if (!res.ok) {
              ...
              console.warn(`Status check failed (${res.status}), continuing polling...`);
              return;
            }
            ...
            if (statusData.status === "processing") {
              ...
              if (shouldUpdate || progressPercent === 100) {
                ...
                if (statusData.eta) {
                  ...
                  const estimatedTotalTime = totalElapsedTime / (progressPercent / 100);
            ...
            if (statusData.status === "queued") {
              ...
              if (statusData.queuePosition && pollCount % 3 === 0) { // Update every 3rd poll
                toast.update(uploadToast, {
            ...
            console.warn(`Polling error (attempt ${pollCount}):`, error.message);
