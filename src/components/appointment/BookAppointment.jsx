...
const BookAppointment = ({ dates, status }) => {
    ...
    return (
        <motion.div
            ...
            className="max-w-4xl mx-auto p-6 bg-white dark:bg-gray-900 rounded-xl shadow-lg border border-gray-100 dark:border-gray-800"
        >
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div
                                        className="absolute inset-0 bg-indigo-500 dark:bg-indigo-600 rounded-lg flex items-center justify-center text-white text-xl font-semibold text-center"
                                    ...
                                    <div
                                        className="absolute inset-0 bg-indigo-600 dark:bg-indigo-700 rounded-lg flex flex-col items-center justify-center text-white p-4"
