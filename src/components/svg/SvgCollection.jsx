...
// newley added
// In your SvgCollection.js file, add these new SVG components:

// Clock SVG for duration display
export const ClockSVG = ({ className = "w-6 h-6", color = "currentColor" }) => (
  <svg 
    className={className} 
    fill="none" 
    stroke={color} 
...
// Trash/Delete SVG
export const TrashSVG = ({ className = "w-6 h-6", color = "currentColor" }) => (
  <svg 
    className={className} 
    fill="none" 
    stroke={color} 
...
// File SVG for file items
export const FileSVG = ({ className = "w-6 h-6", color = "currentColor" }) => (
  <svg 
    className={className} 
    fill="none" 
    stroke={color} 
...
// PDF File SVG (specific for PDF files)
export const PdfSVG = ({ className = "w-6 h-6", color = "currentColor" }) => (
  <svg 
    className={className} 
    fill="none" 
    stroke={color} 
  ...
  >
    ...
    <path 
      ...
      strokeLinejoin="round" 
      strokeWidth={2} 
      d="M9 9h6m-6 4h6m-2 4h2" 
    />
  </svg>
);

// Image File SVG
export const ImageSVG = ({ className = "w-6 h-6", color = "currentColor" }) => (
  <svg 
    className={className} 
    fill="none" 
    stroke={color} 
...
export const CheckSVG = ({ className = "w-6 h-6", color = "currentColor" }) => (
  <svg 
    className={className} 
    fill="none" 
    stroke={color} 
...
// Warning/Alert SVG
export const WarningSVG = ({ className = "w-6 h-6", color = "currentColor" }) => (
  <svg 
    className={className} 
    fill="none" 
    stroke={color} 
...
// Info SVG
export const InfoSVG = ({ className = "w-6 h-6", color = "currentColor" }) => (
  <svg 
    className={className} 
    fill="none" 
    stroke={color} 
...
// Edit/Pencil SVG
export const EditSVG = ({ className = "w-6 h-6", color = "currentColor" }) => (
  <svg 
    className={className} 
    fill="none" 
    stroke={color} 
...
// Drag Handle SVG (for reordering)
export const DragHandleSVG = ({ className = "w-6 h-6", color = "currentColor" }) => (
  <svg 
    className={className} 
    fill="none" 
    stroke={color} 
...
// Eye SVG for visibility
export const EyeSVG = ({ className = "w-6 h-6", color = "currentColor" }) => (
  <svg 
    className={className} 
    fill="none" 
    stroke={color} 
...
// Eye Off SVG for private visibility
export const EyeOffSVG = ({ className = "w-6 h-6", color = "currentColor" }) => (
  <svg 
    className={className} 
    fill="none" 
    stroke={color} 
...
// Download SVG
export const DownloadSVG = ({ className = "w-6 h-6", color = "currentColor" }) => (
  <svg 
    className={className} 
    fill="none" 
    stroke={color} 
...
// Upload SVG
export const UploadSVG = ({ className = "w-6 h-6", color = "currentColor" }) => (
  <svg 
    className={className} 
    fill="none" 
    stroke={color} 
...
// Save/Diskette SVG
export const SaveSVG = ({ className = "w-6 h-6", color = "currentColor" }) => (
  <svg 
    className={className} 
    fill="none" 
    stroke={color} 
...
// Sort/Arrows SVG
export const SortSVG = ({ className = "w-6 h-6", color = "currentColor" }) => (
  <svg 
    className={className} 
    fill="none" 
    stroke={color} 
...
// Calendar SVG (for date picker)
export const CalendarSVG = ({ className = "w-6 h-6", color = "currentColor" }) => (
  <svg 
    className={className} 
    fill="none" 
    stroke={color} 
...
// Tag/Label SVG (for tags)
export const TagSVG = ({ className = "w-6 h-6", color = "currentColor" }) => (
  <svg 
    className={className} 
    fill="none" 
    stroke={color} 
...
// External Link SVG
export const ExternalLinkSVG = ({ className = "w-6 h-6", color = "currentColor" }) => (
  <svg 
    className={className} 
    fill="none" 
    stroke={color} 
